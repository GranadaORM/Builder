 ...
 * @method \MyAppTest\QueryOwner where_id_gt_or_null(string $value) Add a WHERE id > clause to your query
 * @method \MyAppTest\QueryOwner where_id_lt_or_null(string $value) Add a WHERE id < clause to your query
 * @method \MyAppTest\QueryOwner where_id_gte_or_null(string $value) Add a WHERE id >= clause to your query
 * @method \MyAppTest\QueryOwner where_id_lte_or_null(string $value) Add a WHERE id <= clause to your query
 ...
 * @method \MyAppTest\QueryOwner where_name_gt_or_null(string $value) Add a WHERE name > clause to your query
 * @method \MyAppTest\QueryOwner where_name_lt_or_null(string $value) Add a WHERE name < clause to your query
 * @method \MyAppTest\QueryOwner where_name_gte_or_null(string $value) Add a WHERE name >= clause to your query
 * @method \MyAppTest\QueryOwner where_name_lte_or_null(string $value) Add a WHERE name <= clause to your query
 ...
 * @method \MyAppTest\QueryOwner defaultFilter()
