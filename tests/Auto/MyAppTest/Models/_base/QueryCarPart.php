 ...
 * @method \MyAppTest\QueryCarPart where_id_gt_or_null(string $value) Add a WHERE id > clause to your query
 * @method \MyAppTest\QueryCarPart where_id_lt_or_null(string $value) Add a WHERE id < clause to your query
 * @method \MyAppTest\QueryCarPart where_id_gte_or_null(string $value) Add a WHERE id >= clause to your query
 * @method \MyAppTest\QueryCarPart where_id_lte_or_null(string $value) Add a WHERE id <= clause to your query
 ...
 * @method \MyAppTest\QueryCarPart where_car_id_gt_or_null(string $value) Add a WHERE car_id > clause to your query
 * @method \MyAppTest\QueryCarPart where_car_id_lt_or_null(string $value) Add a WHERE car_id < clause to your query
 * @method \MyAppTest\QueryCarPart where_car_id_gte_or_null(string $value) Add a WHERE car_id >= clause to your query
 * @method \MyAppTest\QueryCarPart where_car_id_lte_or_null(string $value) Add a WHERE car_id <= clause to your query
 ...
 * @method \MyAppTest\QueryCarPart where_part_id_gt_or_null(string $value) Add a WHERE part_id > clause to your query
 * @method \MyAppTest\QueryCarPart where_part_id_lt_or_null(string $value) Add a WHERE part_id < clause to your query
 * @method \MyAppTest\QueryCarPart where_part_id_gte_or_null(string $value) Add a WHERE part_id >= clause to your query
 * @method \MyAppTest\QueryCarPart where_part_id_lte_or_null(string $value) Add a WHERE part_id <= clause to your query
 ...
 * @method \MyAppTest\QueryCarPart defaultFilter()
